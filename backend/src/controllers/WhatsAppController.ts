...
export const restart = async (
  ...
  // Buscar o whatsapp default da empresa para reiniciar
  // Ajustando para usar apenas os parâmetros esperados pela função
  const whatsapp = await ShowWhatsAppService(null, companyId, null);
