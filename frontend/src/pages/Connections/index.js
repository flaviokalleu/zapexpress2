...
const Connections = () => {
  ...
  const handleOpenSocialMediaModal = (channelType) => {
  ...
  const handleClickAddChannel = (event) => {
  ...
  const renderActionButtons = (whatsApp) => {
    ...
    if (whatsApp.type === "Instagram") {
      icon = <InstagramIcon className={classes.instagramIcon} />;
    } else if (whatsApp.type === "Facebook") {
      icon = <FacebookIcon className={classes.facebookIcon} />;
    } else {
      // WhatsApp (type === null)
      if (whatsApp.status === "CONNECTED" || whatsApp.status === "PAIRING" || whatsApp.status === "TIMEOUT") {
    ...
    // Botões dinâmicos para WhatsApp nos outros estados
    return (
      <>
  ...
  return (
    <MainContainer>
      ...
      />
      <MainHeader>
        <Title>{i18n.t("Lista de Canais")}</Title>
          ...
          <Can
            ...
            yes={() => (
              <>
                ...
                >
                  <MenuItem onClick={handleSelectWhatsApp}>
                    <WhatsAppIcon className={classes.whatsAppIcon} style={{ marginRight: 8 }} />
                    Canal WhatsApp
                  </MenuItem>
                  <MenuItem onClick={() => handleOpenSocialMediaModal("Instagram")}>
                    <InstagramIcon className={classes.instagramIcon} style={{ marginRight: 8 }} />
                    Canal Instagram
                  </MenuItem>
                  <MenuItem onClick={() => handleOpenSocialMediaModal("Facebook")}>
                    <FacebookIcon className={classes.facebookIcon} style={{ marginRight: 8 }} />
